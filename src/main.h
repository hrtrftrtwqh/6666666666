...
static const int64_t MAX_MONEY = 9000000 * COIN;
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.09 * COIN;
static const int MODIFIER_INTERVAL_SWITCH = 0; 
...
static const uint256 hashGenesisBlock("00000345bd9b79e87fab9db1f26e30d048c51f89c213e1ff0a0d8fc86cb7a055");
static const uint256 hashGenesisBlockTestNet("00000345bd9b79e87fab9db1f26e30d048c51f89c213e1ff0a0d8fc86cb7a055");
...
public:
    ...
    */
    ...
    std::string ToString() const
    {
        ...
        str += strprintf("(hash=%s, nTime=%d, ver=%d, vin.size=%"PRIszu", vout.size=%"PRIszu", nLockTime=%d, msg=\"%s\")\n",
